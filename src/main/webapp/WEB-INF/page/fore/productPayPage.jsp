...
<head>
    ...
    <title>Basketball.com - 网上支付</title>
</head>
<body>
<nav>
        ...
        <c:choose>
            <c:when test="${fn:length(requestScope.productOrder.productOrderItemList)==1}">
                <div class="order_name">
                    <span>Basketball -- ${requestScope.productOrder.productOrderItemList[0].productOrderItem_product.product_name}</span>
                </div>
            ...
            <c:otherwise>
                <div class="order_name">
                    <span>Basketball -- 合并订单：${fn:length(requestScope.productOrder.productOrderItemList)}笔</span>
                </div>
            </c:otherwise>
        </c:choose>
